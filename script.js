...
//  console.log(json);
  ...
  for (let i = 0; i < json.entry.length; i++) {
    ...
    html += `<article class="post"><header><div class="img-box"><img src="${image}" alt="image" class="post-img img-round"></div><h2 class="title">${title}</h2><div class="date">${date}</div></header><p class="body">${body}</p><hr></article>`;
  }
